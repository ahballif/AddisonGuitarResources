...
\begin{exercise}
Play the two octave C major scale as follows. 
Start on the third fret of the A string with the left type scale pattern. 
After reaching the octave, use the right type scale pattern to keep going up to the high A (fret 5 on the high E string). 
Then shift your hand up to play B (fret 7) with your index finger (finger 1) and C (fret 8) with your middle finger. Then work your way back down without moving your hand. You should be able to keep one finger per fret in frets 7-10 to the bottom of the scale. 
\end{exercise}
