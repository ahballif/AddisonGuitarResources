...
Before constructing chord voicings on the guitar we give a brief review of what the chord symbols mean. The following table gives a summary of what 3rds, 7ths, 9ths, 11ths, and 13ths, a variety of typical chord symbols imply. 

\begin{center}
\begin{tabular}{lllllllllllll}
\cline{1-6}
\multicolumn{1}{|l|}{}                          & \multicolumn{1}{l|}{3rd}   & \multicolumn{1}{l|}{7th}   & \multicolumn{1}{l|}{9th} & \multicolumn{1}{l|}{11th}       & \multicolumn{1}{l|}{13th}      &  &  &  &  &  &  &  \\ \cline{1-6}
\multicolumn{1}{|l|}{C$\Delta$}                 & \multicolumn{1}{l|}{Major} & \multicolumn{1}{l|}{Major} & \multicolumn{1}{l|}{9}   & \multicolumn{1}{l|}{-}          & \multicolumn{1}{l|}{13}        &  &  &  &  &  &  &  \\ \cline{1-6}
\multicolumn{1}{|l|}{C$^7$}                     & \multicolumn{1}{l|}{Major} & \multicolumn{1}{l|}{Minor} & \multicolumn{1}{l|}{9}   & \multicolumn{1}{l|}{-}          & \multicolumn{1}{l|}{13}        &  &  &  &  &  &  &  \\ \cline{1-6}
\multicolumn{1}{|l|}{C$^6$}                     & \multicolumn{1}{l|}{Major} & \multicolumn{1}{l|}{6}     & \multicolumn{1}{l|}{9}   & \multicolumn{1}{l|}{-}          & \multicolumn{1}{l|}{13}        &  &  &  &  &  &  &  \\ \cline{1-6}
\multicolumn{1}{|l|}{Cm$^7$}                    & \multicolumn{1}{l|}{Minor} & \multicolumn{1}{l|}{Minor} & \multicolumn{1}{l|}{9}   & \multicolumn{1}{l|}{(11)}       & \multicolumn{1}{l|}{13}        &  &  &  &  &  &  &  \\ \cline{1-6}
\multicolumn{1}{|l|}{Cm$^6$}                    & \multicolumn{1}{l|}{Minor} & \multicolumn{1}{l|}{6}     & \multicolumn{1}{l|}{9}   & \multicolumn{1}{l|}{-}          & \multicolumn{1}{l|}{13}        &  &  &  &  &  &  &  \\ \cline{1-6}
\multicolumn{1}{|l|}{Cm$^(\textrm{\tiny M} 7)$} & \multicolumn{1}{l|}{Minor} & \multicolumn{1}{l|}{Major} & \multicolumn{1}{l|}{9}   & \multicolumn{1}{l|}{-}          & \multicolumn{1}{l|}{13}        &  &  &  &  &  &  &  \\ \cline{1-6}
\multicolumn{1}{|l|}{Cm$^{9\flat 13}$}          & \multicolumn{1}{l|}{Minor} & \multicolumn{1}{l|}{Minor} & \multicolumn{1}{l|}{9}   & \multicolumn{1}{l|}{-}          & \multicolumn{1}{l|}{$\flat$13} &  &  &  &  &  &  &  \\ \cline{1-6}
\multicolumn{1}{|l|}{C$\Delta^{\sharp 11}$}     & \multicolumn{1}{l|}{Major} & \multicolumn{1}{l|}{Major} & \multicolumn{1}{l|}{9}   & \multicolumn{1}{l|}{$\sharp$11} & \multicolumn{1}{l|}{13}        &  &  &  &  &  &  &  \\ \cline{1-6}
